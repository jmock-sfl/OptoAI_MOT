...
def run_on_onnxruntime():
    ...
    onnx_file = 'onnx/solov2_light_r34_3x.onnx'
    input_names = ['input']
    ...
    sess = rt.InferenceSession(onnx_file, providers=['TensorrtExecutionProvider', 'CUDAExecutionProvider'])
